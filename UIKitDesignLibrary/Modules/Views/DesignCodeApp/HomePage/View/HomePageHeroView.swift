    ...
    class HomePageHeroView: UIView {
        ...
        func setupImageView() {
            ...
            NSLayoutConstraint.activate([
                self.backgroundImage.topAnchor.constraint(equalTo: self.topAnchor, constant: -50),
        ...
        func setupTitleLabel() {
            ...
            NSLayoutConstraint.activate([
                ...
                self.titleLabel.centerYAnchor.constraint(equalTo: self.centerYAnchor, constant: -40),
        ...
        func setupPlayButtonView() {
            ...
            NSLayoutConstraint.activate([
                ...
                self.playButtonView.centerYAnchor.constraint(
                    equalTo: self.phoneImageView.centerYAnchor,
                    constant: -12.5),
